import { _ as _extends, x as localeValues, w as withInstall, n as warning, b as _objectSpread2, c as classNames, g as genComponentStyleHook, m as merge, y as resetComponent, N as useConfigContextInject, O as wrapPromiseFn, u as useConfigInject, Q as renderHelper, E as canUseDom, R as updateCSS, T as TinyColor, S as generate, p as useToken, U as useStyleRegister, I as resetIcon, V as defaultConfig, W as defaultIconPrefixCls, X as createTheme, Y as seedToken, Z as useConfigContextProvider, $ as useProvideGlobalForm, e as useProviderSize, h as useProviderDisabled, a0 as LocaleReceiver, a1 as configProviderProps, a2 as DesignTokenProvider, a3 as renderEmpty } from "./index-IfV1sCLI.js";
import { createVNode, defineComponent, reactive, provide, watch, computed, onMounted, onUnmounted, Teleport, ref, TransitionGroup, toRaw, shallowRef, render, watchEffect } from "vue";
import { b as getTransitionGroupProps, P as Portal } from "./transition-AJOM0T1w.js";
import { I as Icon } from "./AntdIcon-DuXnwIrR.js";
import { C as CloseOutlined } from "./CloseOutlined-nOZPpOLa.js";
import { K as Keyframe, g as getMotion$1 } from "./motionUtil-C3pKw7LX.js";
...
defineComponent({
  ...
  setup(props, _ref2) {
    ...
    return createVNode(Notice, _objectSpread2(_objectSpread2({}, attrs), {}, {
      "prefixCls": prefixCls.value,
...
defineComponent({
  ...
  setup(props) {
    ...
    return () => {
      return createVNode(Notice, _objectSpread2(_objectSpread2({}, props), {}, {
        "prefixCls": prefixCls.value,
...
export {
  ...
  getConfirmLocale as a,
  globalConfigForApi as g,
  index as i
};
//# sourceMappingURL=index-Dt2YWyFZ.js.map
